...
KeyboardStyle {
    ...
    property color popupBorderColor: Colors.surface_container_high
    ...
    property color specialKeyActive: Colors.primary
    property color specialKeyActiveText: Colors.on_primary
    property color keyboardBackgroundBorderColor: Colors.shadow
