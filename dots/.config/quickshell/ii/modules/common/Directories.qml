...
Singleton {
    ...
    property string themeScriptPath: FileUtils.trimFileProtocol(`${Directories.scriptPath}/colors/icon-theme.sh`)
    ...
    property string settingsSearchIndex: Quickshell.shellPath("translations/settings_search_index.json")
    // Cleanup on init
